...
const utilities = {
  ...
  "chai-choco-text-latte": `.chai-choco-text-latte   { color: #E8D5B7; }`,
  ...
  "chai-choco-text-milk": `.chai-choco-text-milk    { color: #8B5E3C; }`,
  "chai-choco-text-mid": `.chai-choco-text-mid     { color: #7B4A2D; }`,
  "chai-choco-text-deep": `.chai-choco-text-deep    { color: #4A2515; }`,
  "chai-choco-text-rich": `.chai-choco-text-rich    { color: #3D1F10; }`,
  "chai-choco-text-dark": `.chai-choco-text-dark    { color: #2C1810; }`,
  "chai-choco-text-void": `.chai-choco-text-void    { color: #1a0a00; }`,

  // ── LAYOUT ─────────────────────────────────────────────────────────────────
  "chai-choco-flex": `.chai-choco-flex         { display: flex; }`,
  ...
  "chai-choco-flex-around": `.chai-choco-flex-around  { display: flex; align-items: center; justify-content: space-around; }`,
  ...
  "chai-choco-items-center": `.chai-choco-items-center { align-items: center; }`,
  "chai-choco-items-start": `.chai-choco-items-start  { align-items: flex-start; }`,
  "chai-choco-items-end": `.chai-choco-items-end    { align-items: flex-end; }`,
  "chai-choco-justify-center": `.chai-choco-justify-center  { justify-content: center; }`,
  "chai-choco-justify-between": `.chai-choco-justify-between { justify-content: space-between; }`,
  "chai-choco-flex-1": `.chai-choco-flex-1       { flex: 1; }`,
  "chai-choco-flex-shrink-0": `.chai-choco-flex-shrink-0 { flex-shrink: 0; }`,
  ...
  "chai-choco-grid-4": `.chai-choco-grid-4       { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; }`,
  ...
  // ── TYPOGRAPHY ─────────────────────────────────────────────────────────────
  "chai-choco-font-black": `.chai-choco-font-black      { font-weight: 900; }`,
  "chai-choco-font-extrabold": `.chai-choco-font-extrabold  { font-weight: 800; }`,
  ...
  "chai-choco-font-normal": `.chai-choco-font-normal     { font-weight: 400; }`,
  ...
  "chai-choco-tracking-tightest": `.chai-choco-tracking-tightest { letter-spacing: -0.06em; }`,
  "chai-choco-tracking-tight": `.chai-choco-tracking-tight    { letter-spacing: -0.03em; }`,
  "chai-choco-tracking-normal": `.chai-choco-tracking-normal   { letter-spacing: 0; }`,
  ...
  "chai-choco-leading-none": `.chai-choco-leading-none    { line-height: 1; }`,
  "chai-choco-leading-tight": `.chai-choco-leading-tight   { line-height: 1.15; }`,
  "chai-choco-leading-snug": `.chai-choco-leading-snug    { line-height: 1.35; }`,
  "chai-choco-leading-normal": `.chai-choco-leading-normal  { line-height: 1.5; }`,
  "chai-choco-leading-relaxed": `.chai-choco-leading-relaxed { line-height: 1.7; }`,
  "chai-choco-leading-loose": `.chai-choco-leading-loose   { line-height: 2; }`,
