...
const multiPropRules = [
  { prefix: 'chai-choco-px-', props: (v) => `padding-left: ${v}px; padding-right: ${v}px;`,  multiplier: 4 },
  { prefix: 'chai-choco-py-', props: (v) => `padding-top: ${v}px; padding-bottom: ${v}px;`,  multiplier: 4 },
  { prefix: 'chai-choco-mx-', props: (v) => `margin-left: ${v}px; margin-right: ${v}px;`,    multiplier: 4 },
  { prefix: 'chai-choco-my-', props: (v) => `margin-top: ${v}px; margin-bottom: ${v}px;`,    multiplier: 4 },
];
